...
class CategoryKnowledgeQueryTests(unittest.TestCase):
    ...
    def test_seed_query_builder_handles_empty_models_without_crash(self) -> None:
        ...
        queries, meta = live_review_fetch._build_category_seed_queries(category_row=category_row, site="ebay")
    ...
    def test_seed_query_builder_avoids_cross_brand_series_pairing(self) -> None:
        ...
        queries, _ = live_review_fetch._build_category_seed_queries(category_row=category_row, site="ebay")
    ...
    def test_category_relevance_terms_include_model_and_brand(self) -> None:
        ...
        terms = live_review_fetch._build_category_relevance_terms(category_row)
    ...
    def test_title_matches_category_terms(self) -> None:
        ...
        self.assertTrue(live_review_fetch._title_matches_category_terms("Casio GWM5610-1JF black", terms))
        self.assertFalse(live_review_fetch._title_matches_category_terms("Apple Watch Series 9", terms))
    ...
    def test_match_category_row_uses_data_aliases(self) -> None:
        ...
        with patch.object(live_review_fetch, "_load_category_knowledge", return_value=payload):
            row = live_review_fetch._match_category_row("メンズ 時計 カテゴリ")
